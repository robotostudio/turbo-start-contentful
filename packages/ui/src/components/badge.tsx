...
const badgeVariants = cva(
  "inline-flex items-center rounded-[8px] border px-3 py-0.5 text-xs font-normal transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 relative",
  {
    variants: {
      variant: {
        default:
          "text-primary bg-white dark:before:bg-black/90 bg-[url('/badge-bg.png')] bg-cover bg-center before:content-[''] before:absolute before:inset-[1px] before:bg-white/90 before:rounded-[7px] before:pointer-events-none",
        secondary:
